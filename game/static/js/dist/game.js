...
class GameMap extends AcGameObject
{
    ...
    render()
    {
        this.ctx.fillStyle = "rgba(0, 0, 0, 0.2)"; // 半透明
...
class AcGamePlayground
{
    ...
    get_random_color()
    {
        let colors = ["blue", "green", "red", "pink", "grey"];
...
<div class="ac-game-settings">
    <div class="ac-game-settings-login">
        ...
        <div class="ac-game-settings-acwing">
            <img width="30" src="http://wangyaqii.top/pictures/icon.png">
            <br>
            <div>
            AcOS一键登录
            </div>
    ...
    {  // 在远程服务器上登录
        ...
        $.ajax({
            url: "http://game.wangyaqii.top/settings/login/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    {  // 在远程服务器上注册
        ...
        $.ajax({
            url: "http://game.wangyaqii.top/settings/register/",
            type: "GET",
            data: {
                username: username,
                password: password,
    ...
    {  // 在远程服务器上登出
        ...
        $.ajax({
            url: "http://game.wangyaqii.top/settings/logout/",
            type: "GET",
            success: function(resp) {
                console.log(resp);
                if (resp.result === "success")
    ...
    getinfo()
    {
        ...
        $.ajax({
            url: "http://game.wangyaqii.top/settings/getinfo/",
            type: "GET",
            data: {
